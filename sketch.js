...
function setup() {
 ...
 wall=createSprite(50,200,20,400);
 bullet=createSprite(650,90,30,30);
 bullet2=createSprite(850,150,30,30);
 bullet3=createSprite(850,200,30,30);
 bullet4=createSprite(850,280,30,30);
 ...
 g1=createSprite(900,87,60,50);
 g2=createSprite(900,150,50,30);
 g3=createSprite(900,200,50,30);
 g4=createSprite(900,280,60,50);
